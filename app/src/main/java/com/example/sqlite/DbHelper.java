...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String data = "INSERT INTO TODO VALUES(1,'Hoc Java', 'Hoc Java co ban', '27/02/2023', 'Binh Thuong', 1),"+
                "(2, 'Hoc React Native','Hoc React Native co ban', '24/03/2023', 'Kho', 0)," +
                "(3, 'Hoc Kotlin', 'Hoc Kotlin co ban', '27/02/2023', 'Binh Thuong', 0)";
